...
public class QuestionService implements IQuestionService{
    ...
    public List<Question> getAllQuestionLevelWise(Level level) {
       ...
       switch(level){
        ...
        case LOW:
        return questionRepository.findAllQuestionLevelWise(Level.LOW);
        case MEDIUM:
        return questionRepository.findAllQuestionLevelWise(Level.MEDIUM);
        case HIGH:
        return questionRepository.findAllQuestionLevelWise(Level.HIGH);
        default:
